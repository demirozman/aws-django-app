...
DATABASES = {
    'default': {
        ...
        'HOST': 'dmr-django-rds.cftdjzmkecxf.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'dmr-blog-django' # please enter your s3 bucket name
